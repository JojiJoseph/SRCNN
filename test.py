...
for filename in os.listdir("Set5/HR"):
    if not filename.endswith(".png"):
        continue
    img1 = cv2.imread(f"Set5/HR/{filename}")
    img1_lr = cv2.resize(img1, (img1.shape[1]//4, img1.shape[0]//4),interpolation=cv2.INTER_CUBIC)
